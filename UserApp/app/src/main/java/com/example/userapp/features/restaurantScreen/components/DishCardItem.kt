...
import com.example.userapp.ui.theme.zVegIconColor
import com.example.userapp.ui.theme.zBlack
import com.example.userapp.ui.theme.zDishLabelBg
import com.example.userapp.ui.theme.zDarkGray
import com.example.userapp.ui.theme.zItemAddButtonBg
import com.example.userapp.ui.theme.zDishLabelTextColor
import com.example.userapp.ui.theme.zNonVegIconColor
import com.example.userapp.ui.theme.zRatingCardYellowBg
import com.example.userapp.ui.theme.zRatingCardYellowBorder
import com.example.userapp.ui.theme.zRedColor
import com.example.userapp.ui.theme.zWhite
    ...
    Column(
        ...
        Row(
            ...
            if (isVegetarianDish) {
                Icon(
                    ...
                    contentDescription = "veg or non veg icon",
                    tint = zVegIconColor,
        ...
        if (isRatingAvailable) {
            Card(
                ...
                colors = CardDefaults.cardColors(
                    containerColor = zRatingCardYellowBg,
                ),
            ) {
                Row(
                    verticalAlignment = Alignment.CenterVertically,
...
fun DishImageColumn(
    ...
    Column(
        ...
        Card(
            ...
            colors = CardDefaults.cardColors(
                containerColor = zItemAddButtonBg,
            ),
        ) {
            Box(
